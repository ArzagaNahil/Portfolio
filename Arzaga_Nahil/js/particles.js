...
export function initScene(container, ringPosOverride, showRings = true) {
  ...
  const defaultPos = { x: 3.5, y: 3.5, z: 0 }
  const ringPos = ringPosOverride || defaultPos
  ...
  function animate() {
    ...
    ring && (ring.rotation.x += 0.002, ring.rotation.y += 0.003)
    ring2 && (ring2.rotation.x -= 0.0015, ring2.rotation.y += 0.002)
    ring3 && (ring3.rotation.x += 0.003, ring3.rotation.y -= 0.002)
